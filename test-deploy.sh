...
# 插入测试数据
# 密码 - test
db.getCollection('admins').insert({ rule: 0, nickName: "test-nickName", password: "dbcb2c2c04edc6e7ae9dcb27d9d101e1153ac52ea3ee3d2f432526d72bb81ca22be36f77303dda85eb8d0683a4559036", username: "test" })
# said 测试用户: said/test
