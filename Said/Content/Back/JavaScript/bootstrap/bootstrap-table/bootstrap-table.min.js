...
;(function (a) { a.fn.bootstrapTable.locales["zh-CN"] = { formatLoadingMessage: function () { return "正在努力地加载数据中，请稍候……" }, formatRecordsPerPage: function (b) { return "每页显示 " + b + " 条记录" }, formatShowingRows: function (d, b, c) { return "显示第 " + d + " 到第 " + b + " 条记录，总共 " + c + " 条记录" }, formatSearch: function () { return "搜索" }, formatNoMatches: function () { return "没有找到匹配的记录" }, formatRefresh: function () { return "刷新" }, formatToggle: function () { return "切换" }, formatColumns: function () { return "列" } }; a.extend(a.fn.bootstrapTable.defaults, a.fn.bootstrapTable.locales["zh-CN"]) })(jQuery);